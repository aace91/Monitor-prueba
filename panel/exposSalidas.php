...
<body id="body">
	<div class="container">
		...
		<!-- MODAL VER FACTURAS -->
		<div id="modal_salidas_facturas" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="alta" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
							...
							<div class="col-xs-12">
								<div class="dataTable_wrapper">
									<div class="table-responsive" style="overflow:hidden;">
										<table id="dtsalidas_facturas" class="table table-striped table-bordered" width="100%">
											<thead>
												<tr>
													<th class="def_app_center"># FACTURA</th>
													<th class="def_app_center">VALOR FACTURA</th>
		...
		<!-- MODAL ASIGNAR LOGISTICA -->
		<div id="modal_asign_logistica" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="alta" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title">Asignar Logistica</h4>
					</div>
					<div class="modal-body">	
						<div class="row">
							<div class="col-xs-12 col-md-12">
								<div class="form-group">
									<div class="input-group">	
										<div class="input-group-addon">Logistica:</div>
										<div class="select2-wrapper">
											<select id="isel_logistica" class="form-control"">
												<?php
													...
													// 	echo '<option value="'.$row['logistica'].'">'.$row['nombre'].'</option>';
													// }
												?>							
											</select>
										</div>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-danger pull-left" data-dismiss="modal"><i class="fa fa-ban"></i> Salir</button>
						<button type="button" class="btn btn-success pull-right" onClick="ajax_set_update_logistica();"><i class="fa fa-check-circle"></i> Asignar</button>
					</div>
				</div>
			</div>
		</div>

		<!-- MODAL ASIGNAR BULTOS -->
		<div id="modal_asign_bultos" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="alta" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title">Asignar Bultos</h4>
					</div>
					<div class="modal-body">	
						<div class="row">
							<div class="col-xs-12 col-md-12">
								<div class="form-group">
									<div class="input-group">	
										<div class="input-group-addon">Bultos:</div>
										<input id="itxt_asig_bultos" class="form-control text-uppercase" maxlength="11" />
									</div>	
								</div>				
							</div>
						</div>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-danger pull-left" data-dismiss="modal"><i class="fa fa-ban"></i> Salir</button>
						<button type="button" class="btn btn-success pull-right" onClick="fcn_guardar_bultos();"><i class="fa fa-check-circle"></i> Guardar</button>
					</div>
				</div>
			</div>
		</div>
		...
		<!-- MODAL ENVIAR CORREO -->
		<div id="modal_enviar_correo" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="alta" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					...
					<div class="modal-body">	
						<div class="row">
							<div class="col-xs-12 col-md-12">
								<div class="form-group">
									<div class="input-group">	
										<div class="input-group-addon">Incluir a:</div>
										<select id="isel_enviar_correo_a" class="form-control">
											<option value="">Seleccione una opci&oacute;n</option>
											<option value="arbanda@cablogistics.com.mx">ANA ROSA</option>
											<option value="dahirsch@cablogistics.com.mx">ANDREA</option>
										</select>
									</div>	
								</div>				
							</div>
							...
							<div class="col-xs-12 col-md-12">
								<div class="form-group">
									<div class="input-group">	
										...
										<input id="itxt_enviar_correo_observaciones" class="form-control text-uppercase" maxlength="250" />
									</div>	
								</div>				
							</div>
						</div>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-danger pull-left" data-dismiss="modal"><i class="fa fa-ban"></i> Salir</button>
						<button type="button" class="btn btn-success pull-right" onClick="ajax_set_update_enviar_correo();"><i class="fa fa-check-circle"></i> Guardar</button>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="panel-body">
										...
										<select id="isel_clientes_expo" class="form-control" onChange="ajax_get_grid_salidas_data();">
											<?php
												...
												$consulta = "SELECT b.gcliente, b.cnombre
															 FROM bodega.expos_salidas AS a INNER JOIN
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="dataTable_wrapper">
								<div class="table-responsive" style="overflow:hidden;">
									<table id="dtsalidas" class="table table-striped table-bordered" width="99.8%">
										<thead>
											<tr>
												<th class="def_app_center">SALIDA</th>
												...
												<th class="def_app_center" style="width:120px;">LOGISTICA</th>
												<th class="def_app_center">BULTOS</th>
												...
												<th class="def_app_center">ENVIAR</th>
												<th class="def_app_center">FACTURAS</th>
											</tr>
										</thead>
										<tfoot>
											<tr>
					...
					<div class="row">
						<div class="col-xs-12 col-md-6">
							<button id="ibtn_sync" type="button" class="btn btn-default" onClick="javascript:ajax_set_insert_sync();"><i class="fa fa-refresh" aria-hidden="true"></i> Sincronizar Documentos</button>
	...
	<script src="../js/exposSalidas.js?v=2017.04.10.0900"></script>
</body>

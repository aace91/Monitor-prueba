...
$baseSql = "SELECT p.id_permiso, p.numero_permiso,c.nombre as cliente, 
			...
			FROM permisos_pedimentos_impo p LEFT JOIN
				 bodega.geocel_clientes c ON p.id_cliente = c.f_numcli";

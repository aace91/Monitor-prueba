...
<head>
    ...
    <title>Avisos de adhesion - Monitor De Referencias</title>
...
<body id="body">
	<div class="container">
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title"><i class="fa fa-file-o" aria-hidden="true"></i> Aviso de Adhesi&oacute;n</h4>
					</div>
					<div class="modal-body">
						<div class="row">
							<div class="col-xs-12">
								<div class="form-group">
									<div class="input-group">
										<span class="input-group-addon">N&uacute;mero de autorizaci&oacute;n</span>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div id="subir_archivo_aviso" style="display:none;">
									<div class="form-group">
										<label class="control-label">Documento del Aviso de Adhesi&oacute;n (pdf)</label>
		...
		<div class="jumbotron" style="padding: 10px; margin: 0px;"> 
			<div class="panel panel-default" style="margin-bottom: 0px;">
				<div class="panel-heading">
					<h2><strong><i class="	glyphicon glyphicon-file" aria-hidden="true"></i> Avisos de Adhesi&oacute;n</strong></h2>
				</div>
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group pull-right">
								<button id="ibtn_nuevo" type="button" class="btn btn-success" onClick="javascript:agregar_permiso_pedimento();"><i class="fa fa-file-o" aria-hidden="true"></i> Nuevo Aviso de Adhesi&oacute;n</button>
							</div>
						</div>
					</div>
								...
								<div class="table-responsive" style="overflow:hidden;">
									<table id="dt_principal_general" class="table table-striped table-bordered" width="99.8%">
										<thead>
											<tr>
												<th>#</th>
												<th>Número Autorizaci&oacute;n</th>
												<th>Vigencia</th>
												<th>Cliente</th>
	...
	<script src="../js/avisos_adhesion.js?v=2017.09.11.1106"></script>
</body>

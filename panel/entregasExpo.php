...
<head>
    ...
    <title>Monitor - Puntos entrega exportacion</title>
...
<body>
	<div class="container">
		...
		<div class="jumbotron"> 
		<h2>Exportaciones <small>Catalogo puntos de entrega</small></h2>
		<br>
		<div class="row">
			<div class="table-responsive">
				<table id="dtentregasExpo" class="table table-striped table-bordered" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>ID</th>
							<th>Nombre</th>

...
<head>
    ...
    <title>Monitor - Entradas exportacion</title>
...
<body>
	...
	<div class="container">
		...
		<div class="jumbotron"> 
		<h2>Exportaciones <small>Entradas</small></h2>
		<br>
		<div class="row">
			<div class="table-responsive">
				<table id="dtentradasExpo" class="table table-striped table-bordered" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>Referencia</th>
							<th>Fecha alta</th>
	...
	<script src="../js/entradasExpo.js?171020171700"></script>
</body>
</html>
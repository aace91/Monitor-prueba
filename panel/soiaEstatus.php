...
<head>
    ...
    <title>Consulta Rapida SOIA</title>
...
<body id="body">
		...
		<div class="jumbotron" style="padding: 10px; margin: 0px;"> 
			<div id="idiv_panel_principal" class="panel panel-default" style="margin-bottom: 0px;">
				<div class="panel-heading">
					<strong> Consulta Rapida SOIA</strong> <small></small>
				</div>
						...
						<div class="col-xs-12">
							<div class="dataTable_wrapper">
								<div class="table-responsive" style="overflow:hidden;">
									<table id="dtestatus" class="table table-striped table-bordered" width="100%">
										<thead>
											<tr>
												<th class="def_app_center">PEDIMENTO</th>
												<th class="def_app_center">REFERENCIA</th>
												<th class="def_app_center">REMESA</th>
												<th class="def_app_center">ESTADO ACTUAL</th>
												<th class="def_app_center">VERDE/ROJO</th>
												<th class="def_app_center">DETALLE</th>
											</tr>
										</thead>
										<tfoot>
											<tr>
	...
	<script src="../js/soiaEstatus.js?v=2017.09.11.0900"></script>
</body>

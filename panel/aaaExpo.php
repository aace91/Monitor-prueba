...
<head>
    ...
    <title>Monitor - AAA exportacion</title>
...
<body>
	<div class="container">
		...
		<div class="jumbotron"> 
		<h2>Exportaciones <small>Agentes Aduanales Americanos</small></h2>
		<br>
		<div class="row">
			<div class="table-responsive">
				<table id="dtaaaExpo" class="table table-striped table-bordered" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>ID</th>
							<th>Nombre</th>
	...
	<script src="../js/catalogosExpo.js?250920170900"></script>
</body>
</html>
...
if (!isset($_GET['id'])) {
	exit("No se recibio el numero de relación");
}
$relacion=$_GET['id'];
$selection_formula = "{servicios.id_relacion} = ".$relacion;
...
$my_report = $dir_rpt_relacion_servicios."RelacionServicios.rpt";//C:\\inetpub\\wwwroot\\monitorpruebas\\panel\\
$my_pdf = tempnam("", "CR");;
try
{
...
//    $ObjectFactory = null;
	...
	if (headers_sent()) {
		...
		header("Content-Disposition: attachment; filename=\"RelServ_".rtrim($relacion).".pdf\"");
